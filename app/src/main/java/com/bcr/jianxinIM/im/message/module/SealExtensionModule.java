package com.bcr.jianxinIM.im.message.module;
...
//                if (pluginModuleList != null) {
//                    for (IPluginModule module : pluginModuleList) {
