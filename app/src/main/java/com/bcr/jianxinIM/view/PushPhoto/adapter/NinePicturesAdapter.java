package com.bcr.jianxinIM.view.PushPhoto.adapter;
...
import com.bcr.jianxinIM.view.PushPhoto.BigImagePagerActivity;
import com.bcr.jianxinIM.view.PushPhoto.util.ImageLoaderUtils;
import com.bcr.jianxinIM.view.PushPhoto.util.ViewHolderUtil;
...
public class NinePicturesAdapter extends BaseAblistViewAdapter<String> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final SelectableRoundedImageView imageView = ViewHolderUtil.get(convertView, R.id.img_photo);
