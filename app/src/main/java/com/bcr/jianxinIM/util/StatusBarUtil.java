...
public class StatusBarUtil {
    ...
    public StatusBarUtil setDrawable(Drawable drawable) {
        mDrawable = drawable;
        return this;
    }
    ...
    public StatusBarUtil setIsActionBar(boolean actionBar) {
     ...
     * @return
     */
    public StatusBarUtil setDrawerLayoutContentId(boolean drawerLayout, int contentId) {
     ...
     * 去除 ActionBar 阴影
     */
    public StatusBarUtil clearActionBarShadow() {
