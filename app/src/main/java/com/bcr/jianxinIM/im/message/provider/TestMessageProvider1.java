...
import com.bcr.jianxinIM.im.message.TestMessage1;
...
@ProviderTag(messageContent = TestMessage1.class, showReadState = true)
public class TestMessageProvider1 extends IContainerItemProvider.MessageProvider<TestMessage1> {
    ...
    public View newView(Context context, ViewGroup group) {
        ...
        TestMessageProvider1.ViewHolder holder = new TestMessageProvider1.ViewHolder();
    ...
    @Override
    public Spannable getContentSummary(TestMessage1 data) {
        return null;
    }

    @Override
    public Spannable getContentSummary(Context context, TestMessage1 data) {
        if (data == null)
            return null;
    ...
    @Override
    public void onItemClick(View view, int position, TestMessage1 content, UIMessage message) {

    }

    @Override
    public void onItemLongClick(final View view, int position, final TestMessage1 content, final UIMessage message) {

        TestMessageProvider1.ViewHolder holder = (TestMessageProvider1.ViewHolder) view.getTag();
        ...
        System.out.println("11:-->"+message.getConversationType());
        System.out.println("11:-->"+message.getTargetId());
        System.out.println("11:-->"+message.getContent());
        System.out.println("11:-->"+message.getSenderUserId());
        System.out.println("11:-->"+message.getUserInfo());
        if (hasSent
                && enableMessageRecall
...
//        }).show();
    ...
    @Override
    public void bindView(final View v, int position, final TestMessage1 content, final UIMessage data) {
        TestMessageProvider1.ViewHolder holder = (TestMessageProvider1.ViewHolder) v.getTag();
