...
package com.bcr.jianxinIM.zxinglibrary.camera;
...
import com.bcr.jianxinIM.zxinglibrary.android.CaptureActivityHandler;
...
//    }
    ...
    public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data,
        ...
        if (config.isFullScreenScan()) {
            ...
            int actionbarHeight = context.getResources().getDimensionPixelSize(R.dimen.callkit_dimen_size_48);
