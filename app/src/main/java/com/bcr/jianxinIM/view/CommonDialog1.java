...
public class CommonDialog1 extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (params != null) {
            ...
            if (params.positiveText.length() > 0) {
                positive.setText(params.positiveText);
            }

            if (params.negativeText.length()  > 0) {
                negative.setText(params.negativeText);
            }

            if (params.titleText.length()  > 0) {
    ...
    public static class Builder {
        ...
        public Builder setButtonText(String positiveText, String negativeText) {
        ...
        public CommonDialog1 build() {
            CommonDialog1 dialog = getCurrentDialog();
            dialog.setParams(params);
            return dialog;
        }


        protected CommonDialog1 getCurrentDialog() {
            return new CommonDialog1();
        }
    }
}
