...
public class CircleOfFriends01Activity extends BaseActivity implements BaseQuickAdapter.RequestLoadMoreListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private static final String TAG = "CircleOfFriends01Activity";
...
//                .process();
    ...
    private void initUserInfo() {
        AsyncTaskManager.getInstance(mContext).request(GETUSERINFO, new OnDataListener() {
            ...
            public Object doInBackground(int requestCode, String parameter) throws HttpException {
                return new SealAction(mContext).GetUserInfo(SharedPreferencesUtil.getString(mContext,"userId",""),SharedPreferencesUtil.getString(mContext,"userId",""));
            }
    ...
    private void initUI() {
        ...
        tvPost.setOnClickListener(v -> {
            if (ContextCompat.checkSelfPermission(CircleOfFriends01Activity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(CircleOfFriends01Activity.this, new String[]{Manifest.permission.CAMERA, Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.MOUNT_UNMOUNT_FILESYSTEMS}, 1);
            } else {
       ...
       // mRecyclerView.setLayoutManager(new ScrollSpeedLinearLayoutManger(this));
        ...
        riv_avatar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                UserInfo userInfo = new UserInfo(SharedPreferencesUtil.getString(getContext(),"userId",""), userName, TextUtils.isEmpty(userpic.toString()) ? Uri.parse(RongGenerate.generateDefaultAvatar(userName,userid)) : myUri);
       ...
       // mRecyclerView.addOnLayoutChangeListener(this);
        ...
        mAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
               ...
               //circleFriendsModel1 = data.get(position);
...
//        });
    ...
    public void handleEvent(EventBusCarrier carrier) {
       ...
       circleFriendsModel1=carrier.getCircleFriendsModel1();
        ...
        if(type==1) {
            if(commentBean.getMyuser().getUserId().equals(userid)){
    ...
    private void initData(int pageNum, final boolean isloadmore) {
        ...
        HttpUtil.post(BaseAction.DOMAIN+"/Dynamic.ashx?Method=Get_Dynamic", params, new HttpUtil.RequestListener() {
            @Override
    ...
    private void toDel(String userid, String id) {
        ...
        AsyncTaskManager.getInstance(mContext).request(DELCIR, new OnDataListener() {
            @Override
            public Object doInBackground(int requestCode, String parameter) throws HttpException {
                return new SealAction(mContext).DeleteCirFriend(SharedPreferencesUtil.getString(mContext,"userId",""),id);
            }
            ...
            public void onSuccess(int requestCode, Object result) {
                ...
                if (result != null) {
                    ...
                    if(cirFriendComRespone.isSuccess()==true){
                        ...
                        Logger.d("getFriendId:-->"+cirFriendComRespone.getResultData().getFriendId());
                        Logger.d("getFriendName:-->"+cirFriendComRespone.getResultData().getFriendName());
                        Logger.d("getUserId:-->"+cirFriendComRespone.getResultData().getUserId());
                        Logger.d("getUserNickName:-->"+cirFriendComRespone.getResultData().getUserNickName());
                        CircleFriendsModel1.CommentBean commentBean=new CircleFriendsModel1.CommentBean();
    ...
    private void toDelCom(String comId, CircleFriendsModel1 circleFriendsModel1, CircleFriendsModel1.CommentBean commentBean) {
        ...
        AsyncTaskManager.getInstance(mContext).request(DELCOM, new OnDataListener() {
            @Override
            public Object doInBackground(int requestCode, String parameter) throws HttpException {
                return new SealAction(mContext).DeleteCom(SharedPreferencesUtil.getString(mContext,"userId",""),comId);
            }
            @Override
            public void onSuccess(int requestCode, Object result) {
                LoadDialog.dismiss(mContext);
        ...
        swipeRefreshLayoutVTO.addOnGlobalLayoutListener(() -> {
           ...
           currentKeyboardH = keyboardH;
            ...
            if (keyboardH < 150) {//说明是隐藏键盘的情况
                CircleOfFriends01Activity.this.updateEditTextBodyVisible(View.GONE);
                return;
            }
        });
    }
