...
public class MultiVideoCallActivity extends BaseCallActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StateAppBar.setStatusBarLightMode(this,getResources().getColor(R.color.rc_voip_background_color));
//        Sofia.with(this)
    ...
    void addRemoteVideo(View singleRemoteView, SurfaceView video, String userId) {
        ...
        if (userInfo != null) {
            if (userInfo.getPortraitUri() != null) {
                userPortraitView.setAvatar(userInfo.getPortraitUri().toString(), R.drawable.rc_default_portrait1);
            }
        }
...
//                    iv_large_preview_Mask.setVisibility(View.VISIBLE);
                ...
                for (int i = 0; i < invitedList.size(); i++) {
                    ...
                    if (userInfo != null && userInfo.getPortraitUri() != null) {
                        portraitView.setAvatar(userInfo.getPortraitUri().toString(), R.drawable.rc_default_portrait1);
                    }
    ...
    public void onSwitchRemoteUsers(View view) {
        ...
        if (toUserInfo != null) {
            if (toUserInfo.getPortraitUri() != null) {
                userPortraitView.setAvatar(toUserInfo.getPortraitUri().toString(), R.drawable.rc_default_portrait1);
            }
        }
