...
public class NewFriendListAdapter extends BaseAdapters {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final UserRelationshipResponse.ResultDataBean bean = (UserRelationshipResponse.ResultDataBean) dataSet.get(position);
        ...
        ImageLoader.getInstance().displayImage(portraitUri, holder.mHead);
