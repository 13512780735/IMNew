...
package com.bcr.jianxinIM.im.server.network.download;
...
import com.bcr.jianxinIM.im.server.network.http.AsyncHttpClient;
import com.bcr.jianxinIM.im.server.network.http.AsyncHttpResponseHandler;
import com.bcr.jianxinIM.im.server.network.http.BreakpointHttpResponseHandler;
